...
func ParseStartBody(c *gin.Context) (data models.StartBody, err error) {
	...
	isBodyEmpty := ContainsEmpty(data.AppID, data.ChannelName, data.CustomerKey, data.CustomerSecret, data.ResourceID, data.Token, data.MaxIdleTime, data.RecordingID, data.UserID)
	isStorageEmpty := ContainsEmpty(data.Storage.BucketAccessKey, data.Storage.BucketID, data.Storage.BucketSecretKey, data.Storage.Dir1, data.Storage.Dir2)
...
func ParseStopBody(c *gin.Context) (data models.StopBody, err error) {
	...
	isEmpty := ContainsEmpty(data.AppID, data.ChannelName, data.CustomerKey, data.CustomerSecret, data.ResourceID, data.SID, data.RecordingID)
